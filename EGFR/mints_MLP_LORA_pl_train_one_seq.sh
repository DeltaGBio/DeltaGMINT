...
train_data="/pasteur/appa/scratch/dvu/github/DeltaGMINT/EGFR/dataset/EGFR_train.csv"
test_data="/pasteur/appa/scratch/dvu/github/DeltaGMINT/EGFR/dataset/EGFR_test.csv"
